...
export async function POST() {
  try {
    ...
    const products = await Promise.all([
      // Electrónica
      db.affiliateProduct.create({
        data: {
          title: 'Auriculares Bluetooth TWS Noise Cancelling',
          description: 'Auriculares inalámbricos con cancelación de ruido activa, 30hs de batería, IPX5. Estuche con carga inalámbrica incluido.',
          price: 25900,
          originalPrice: 45000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.amazon.com/dp/B08AUDIO1',
          source: 'amazon',
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Cargador Rápido 65W GaN USB-C PD 3.0',
          description: 'Cargador de pared con tecnología GaN, 65W, 3 puertos (2 USB-C + 1 USB-A). Compatible con notebooks, celulares y tablets.',
          price: 18500,
          originalPrice: 32000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.aliexpress.com/item/32456789',
          source: 'aliexpress',
          category: 'Electrónica',
          brand: 'Baseus',
          rating: 4.4,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Power Bank 20000mAh Carga Rápida 22.5W',
          description: 'Batería externa de alta capacidad con carga rápida, 2 puertos USB-A y 1 USB-C. Diseño compacto, LED indicador.',
          price: 14500,
          originalPrice: 22000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.temu.com/item/powerbank20k',
          source: 'temu',
          category: 'Electrónica',
          brand: 'Xiaomi',
          rating: 4.3,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Smartwatch Deportivo AMOLED GPS Integrado',
          description: 'Reloj inteligente con pantalla AMOLED 1.43", GPS, monitoreo de ritmo cardíaco, SpO2, 100+ modos deportivos. Resistente al agua 5ATM.',
          price: 125000,
          originalPrice: 180000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.mercadolibre.com.ar/p/MLA123456',
          source: 'mercadolibre',
          category: 'Electrónica',
          brand: 'Huawei',
          rating: 4.7,
      ...
      db.affiliateProduct.create({
        data: {
          ...
          description: 'Taladro percutor con batería de litio 20V, 2 velocidades, mandril de quick-release. Incluye maletín y accesorios.',
          price: 89900,
          originalPrice: 129900,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.amazon.com/dp/B08TOOL01',
          source: 'amazon',
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Set de Llaves Combinadas 14 Piezas Cromadas',
          description: 'Juego de llaves combinadas 6-22mm de acero cromado vanadio. Incluye maletín organizador.',
          price: 32000,
          originalPrice: 48000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.ebay.com/itm/LLAVES14',
          source: 'ebay',
          category: 'Herramientas',
          brand: 'Stanley',
          rating: 4.6,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Sierra Caladora 700W con Láminas',
          description: 'Sierra caladora eléctrica 700W, corte en madera 65mm y metal 10mm. Incluye 3 láminas, guía de corte y maletín.',
          price: 67500,
          originalPrice: 95000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.mercadolibre.com.ar/p/MLA789012',
          source: 'mercadolibre',
          category: 'Herramientas',
          brand: 'Bosch',
          rating: 4.4,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Nivel Láser Verde Auto-Nivelante 360°',
          description: 'Nivel láser verde con línea 360° horizontal y vertical, auto-nivelante, alcance 20m. Incluye trípode y maletín.',
          price: 85000,
          originalPrice: 120000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.aliexpress.com/item/98765432',
          source: 'aliexpress',
          category: 'Herramientas',
          brand: 'Huepar',
          rating: 4.5,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Lámpara LED de Escritorio regulable Touch',
          description: 'Lámpara LED con regulación de brillo y temperatura de color (3000K-6500K). Brazo flexible, base estable, USB de carga.',
          price: 15800,
          originalPrice: 25000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.temu.com/item/lampled01',
          source: 'temu',
          category: 'Hogar',
          brand: 'Genérica',
          rating: 4.2,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Organizador de Ropa Colgante 6 Compartimentos',
          description: 'Organizador colgante resistente con 6 compartimentos transparentes. Ideal para guardar ropa, accesorios y zapatos.',
          price: 8900,
          originalPrice: 15000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.shein.com/item/ORG06',
          source: 'shein',
          category: 'Hogar',
          brand: 'SHIEN HOME',
          rating: 4.0,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Humidificador de Ambiente Ultrasónico 4L',
          description: 'Humidificador ultrasónico con tanque de 4L, modo nocturno con luz LED, apagado automático. Silencioso (menos de 30dB).',
          price: 22000,
          originalPrice: 35000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.ebay.com/itm/HUMID04L',
          source: 'ebay',
          category: 'Hogar',
          brand: 'Levoit',
          rating: 4.6,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Aspiradora Verticales Sin Cable 25000Pa',
          description: 'Aspiradora vertical inalámbrica con potencia de succión 25000Pa, batería 45min, LED en la boquilla, filtro HEPA.',
          price: 185000,
          originalPrice: 280000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.amazon.com/dp/B08VAC01',
          source: 'amazon',
          category: 'Hogar',
          brand: 'Dyson',
          rating: 4.8,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Teclado Mecánico RGB Hot-Switchable 75%',
          description: 'Teclado mecánico compacto 75% con switches intercambiables, retroiluminación RGB, conexión inalámbrica triple (BT/2.4G/USB-C).',
          price: 55000,
          originalPrice: 78000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.aliexpress.com/item/11223344',
          source: 'aliexpress',
          category: 'Tecnología',
          brand: 'Keychron',
          rating: 4.7,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Mouse Gamer Inalámbrico 16000DPI RGB',
          description: 'Mouse gaming con sensor óptico 16000DPI, 6 botones programables, peso ajustable, batería recargable, iluminación RGB.',
          price: 19500,
          originalPrice: 30000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.temu.com/item/mousegamer1',
          source: 'temu',
          category: 'Tecnología',
          brand: 'Redragon',
          rating: 4.3,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Monitor Portátil 15.6" IPS 1080P USB-C',
          description: 'Monitor externo portátil 15.6 pulgadas Full HD IPS, tipo C, HDR, altavoces integrados, cubierta magnética. Peso: 680g.',
          price: 165000,
          originalPrice: 220000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.mercadolibre.com.ar/p/MLA345678',
          source: 'mercadolibre',
          category: 'Tecnología',
          brand: 'ASUS',
          rating: 4.5,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Cable HDMI 2.1 Ultra High Speed 8K 2m',
          description: 'Cable HDMI 2.1 de 2 metros, soporta 8K@60Hz y 4K@120Hz. Compatible con PS5, Xbox Series X, Roku, Apple TV.',
          price: 7500,
          originalPrice: null,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.ebay.com/itm/HDMI21CABLE',
          source: 'ebay',
          category: 'Tecnología',
          brand: 'Amazon Basics',
          rating: 4.4,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Campera Rompevientos Impermeable Unisex',
          description: 'Campera de viento con capucha, impermeable y transpirable, bolsillos con cierre, ajuste en puño y cintura. Tallas S a XXL.',
          price: 28000,
          originalPrice: 45000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.shein.com/item/ROMPEV1',
          source: 'shein',
          category: 'Ropa',
          brand: 'SHEIN',
          rating: 3.8,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Zapatillas Running Livianas Amortiguación Gel',
          description: 'Zapatillas de running con suela de gel, malla transpirable, planta anatómica removible. Ideales para entrenamiento diario.',
          price: 65000,
          originalPrice: 95000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.mercadolibre.com.ar/p/MLA901234',
          source: 'mercadolibre',
          category: 'Ropa',
          brand: 'Asics',
          rating: 4.5,
      ...
      db.affiliateProduct.create({
        data: {
          ...
          description: 'Botella térmica de doble pared, mantiene frío 24hs y caliente 12hs. Acero inoxidable 304, libre de BPA, tapa anti-goteo.',
          price: 12000,
          originalPrice: 18000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.amazon.com/dp/B08BOTELA',
          source: 'amazon',
          category: 'Deportes',
          brand: 'Yeti',
          rating: 4.8,
      ...
      db.affiliateProduct.create({
        data: {
          title: 'Colchoneta Yoga TPE 6mm Antideslizante',
          description: 'Colchoneta de yoga ecológica TPE de 6mm, doble textura antideslizante, liviana (800g), incluye correa de transporte.',
          price: 18500,
          originalPrice: 28000,
          currency: 'ARS',
          imageUrl: '/placeholder-product.jpg',
          sourceUrl: 'https://www.aliexpress.com/item/YOGAMAT6',
          source: 'aliexpress',
          category: 'Deportes',
          brand: 'Liforme',
          rating: 4.3,
